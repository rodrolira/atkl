            ...
            <table className="w-full border-collapse">
                <thead>
                    <tr className="bg-[#194116]">
                        <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Release Name</th>
                        <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Artist</th>
                        <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Release Date</th>
                ...
                <tbody>
                    {releases.map((release) => (
                        <tr key={release.id} className="border-t border-t-[#2e7728]">
                            <td className="px-4 py-3 w-1/4 text-white text-sm">{release.title}</td>
                            ...
                            <td className="px-4 py-3 w-1/4 text-white text-sm">{release.release_date}</td>
