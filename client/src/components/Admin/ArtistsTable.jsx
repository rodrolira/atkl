...
const ArtistsTable = ({ artists, onEdit, onDelete, selectedArtists, setSelectedArtists, isDeleteMode }) => {
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="bg-[#194116]">
                            ...
                            <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Artist Name</th>
                            <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Email</th>
                            <th className="px-4 py-3 text-center w-1/4 text-white text-sm font-medium">Roles</th> {/* Nueva columna de roles */}
                            <th className="px-4 py-3 text-center w-1/4 text-[#8bd685] text-sm font-medium">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {artists.map((artist) => (
                            <tr key={artist.id} className="border-t border-t-[#2e7728]">
                                ...
                                <td className="px-4 py-3 w-1/4 text-white text-sm">{artist.artist_name}</td>
                                <td className="px-4 py-3 w-1/4 text-[#8bd685] text-sm">{artist.email}</td>
